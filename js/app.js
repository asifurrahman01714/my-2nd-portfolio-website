...
/*FIXED NAVBAR*/
  $(window).scroll(function(){
    ...
    if(navFixed > 200){
      $(".main-nav").removeClass("py-30").addClass("fixed-top py-15 bg-white nav-border animated fadeInDown faster");
      $(".hero_cont").addClass("mt-120");
    }else{
      $(".main-nav").removeClass("fixed-top py-15 bg-white nav-border animated fadeInDown faster").addClass("py-30");
